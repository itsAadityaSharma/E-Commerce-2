...
import { ITEMS_PER_PAGE } from "../../../app/comstants";
        ...
        <div className="bg-white">
          <div>
            ...
            <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              {/* section ofproduct and filter end here */}
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        ...
        <div>
          ...
          >
            <div
              onClick={(e) => {
                page == 1 ? handlePage(e, 1) : handlePage(e, page - 1);
              }}
        ...
        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
          {products.map((product) => (
            <div>
                ...
                >
                  ...
                  <div className="mt-4 flex justify-between">
                    ...
                    <div>
                      ...
                      <p className="text-sm line-through  block font-medium text-red-400">
                        ${product.price}
                      </p>
                    </div>
                  </div>
              ...
              <div className="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
